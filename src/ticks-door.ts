...
/** x402scan origin page for the live paid doors. /ncua-orders is a live public SKU. */
...
export type DoorSku = "ticks" | "import-alerts" | "mariners" | "mariners-d11" | "mariners-d7" | "mariners-d8" | "warning-letters" | "untitled-letters" | "awa" | "swisspar" | "pcac" | "ftc-wl" | "cfpb-orders" | "occ-cd" | "fdic-orders" | "frb-orders" | "ncua-orders" | "form-483" | "gmp" | "gmp-md";
...
function noNextSkuWord(): string {
  ...
  return `/ncua-orders is a live public SKU on purpose. No ${next} public SKU.`;
}
