 ...
 * Not ICO /ico-mpn. Not Superfund /superfund-rods. Wired on the ico-mpn live lineage; stay off catalogs until live-applied.
 */
...
export function buildCmaCa98Manifest(snap: CmaCa98Snapshot | null): Record<string, unknown> {
  ...
  return {
    ...
    name: PRODUCT_NAME,
    free: true,
    note: "Count + institution + docket + date + official PDF URL only. Decision body is the paid GET /cma-ca98 payload. Not people. Not the press teaser. Not ICO /ico-mpn. Not Superfund /superfund-rods. Wired on the ico-mpn live lineage; stay off catalogs until live-applied.",
    license: LICENSE,
    attribution: ATTRIBUTION,
