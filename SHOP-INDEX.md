...
Same order as live [/.well-known/x402](https://ticks.bnm.farm/.well-known/x402), plus `/gain` listed here (first slice; not live until apply). Tables: **$0.05** = entire current table. Mariners: **$0.05** = this week's LNM. Body doors: free search, then **$0.02** one official text (`?id=`) or **$0.05** newest 10 (older page `?before=`).
