...
| --- | --- | --- | ---: | --- | --- |
| `/ticks` | USDA farm market prices (hay, cattle, grain, dairy, hogs, produce, eggs). Idaho / PNW barns are example geography inside the table, not the SKU. Not water. Entire current table on one GET | `ticks[] + history` | 611 ticks | $0.05 | [manifest.json](https://ticks.bnm.farm/manifest.json) |
...
| `/fdic-orders` | FDIC institution consent-order / C&D text. Newest 10 official texts | `cards[].body` | 26 cards | $0.05 | [fdic-orders/manifest.json](https://ticks.bnm.farm/fdic-orders/manifest.json) |
...
| `/superfund-rods` | EPA Superfund Record of Decision and Five-Year Review text. Newest 10 official texts | `cards[].body` | 5 cards | $0.05 | [superfund-rods/manifest.json](https://ticks.bnm.farm/superfund-rods/manifest.json) |
