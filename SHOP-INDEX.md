...
| --- | --- | --- | --- |
| `/ticks` | US hay, cattle, and grain ticks (USDA AMS nationwide plus official dairy, hogs, and terminal produce). Entire current table | $0.05 | [manifest.json](https://ticks.bnm.farm/manifest.json) |
...
| `/phmsa-orders` | PHMSA pipeline enforcement-order text (official primis.phmsa.dot.gov PDFs). Newest 10 official texts | $0.02 / $0.05 | [manifest.json?q=](https://ticks.bnm.farm/phmsa-orders/manifest.json?q=) |
...
| `/csb-reports` | US CSB final investigation report PDFs. One official PDF | $0.05 | [manifest.json?q=](https://ticks.bnm.farm/csb-reports/manifest.json?q=) |
