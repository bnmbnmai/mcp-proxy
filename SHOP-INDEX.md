...
Same order as live [/.well-known/x402](https://ticks.bnm.farm/.well-known/x402), plus `/ofwat-enforcement` listed here (first slice; not live until apply). Tables: **$0.05** = entire current table. Mariners: **$0.05** = this week's LNM. Body doors: free search, then **$0.02** one official text (`?id=`) or **$0.05** newest 10 (older page `?before=`).
...
| `/ofwat-enforcement` | Ofwat Water Industry Act 1991 enforcement-notice / final-decision / s.19-undertakings text (official ofwat.gov.uk PDFs, OGL v3.0). First slice: two harvested texts. Newest 10 official texts | $0.02 / $0.05 | [manifest.json?q=](https://ticks.bnm.farm/ofwat-enforcement/manifest.json?q=) |
