...
- `GET /openapi.json` — OpenAPI 3.1 generated from live well-known.
...
| `/ofwat-enforcement` | Ofwat Water Industry Act 1991 enforcement-notice text. Newest 10 official texts | $0.02 / $0.05 |
