...
- **BNM Data Shop (separate host):** live 32-door official public-data catalog — [`docs/SHOP-INDEX.md`](docs/SHOP-INDEX.md) · [bnm.farm](https://bnm.farm/) · [discovery](https://ticks.bnm.farm/.well-known/x402) · [OpenAPI](https://ticks.bnm.farm/openapi.json) · [llms.txt](https://ticks.bnm.farm/llms.txt)
