...
for prefix in \
  ...
  AAIB_REPORTS CSB_REPORTS HHS_OIG_REPORTS FSIS_HUMANE EPA_CAFO FMSHRC_ORDERS BSEE_REPORTS OSHRC_ORDERS EPA_ALJ EPA_EAB STB_DECISIONS OALJ_DECISIONS FMC_ORDERS FTC_ORDERS NLRB_DECISIONS FLRA_DECISIONS ECAB_DECISIONS
do
  set_grow "$prefix"
done
