...
export FMSHRC_ORDERS_DIR="${FMSHRC_ORDERS_DIR:-$MCP/data/fmshrc-orders}"
export BSEE_REPORTS_DIR="${BSEE_REPORTS_DIR:-$MCP/data/bsee-reports}"
export OSHRC_ORDERS_DIR="${OSHRC_ORDERS_DIR:-$MCP/data/oshrc-orders}"
export EPA_ALJ_DIR="${EPA_ALJ_DIR:-$MCP/data/epa-alj}"
export EPA_EAB_DIR="${EPA_EAB_DIR:-$MCP/data/epa-eab}"
export STB_DECISIONS_DIR="${STB_DECISIONS_DIR:-$MCP/data/stb-decisions}"
export OALJ_DECISIONS_DIR="${OALJ_DECISIONS_DIR:-$MCP/data/oalj-decisions}"
export FMC_ORDERS_DIR="${FMC_ORDERS_DIR:-$MCP/data/fmc-orders}"
export FTC_ORDERS_DIR="${FTC_ORDERS_DIR:-$MCP/data/ftc-orders}"
export NLRB_DECISIONS_DIR="${NLRB_DECISIONS_DIR:-$MCP/data/nlrb-decisions}"
export FLRA_DECISIONS_DIR="${FLRA_DECISIONS_DIR:-$MCP/data/flra-decisions}"
export ECAB_DECISIONS_DIR="${ECAB_DECISIONS_DIR:-$MCP/data/ecab-decisions}"
export FCC_EB_ORDERS_DIR="${FCC_EB_ORDERS_DIR:-$MCP/data/fcc-eb-orders}"
export NMB_DETERMINATIONS_DIR="${NMB_DETERMINATIONS_DIR:-$MCP/data/nmb-determinations}"
export EEOC_APPELLATE_DIR="${EEOC_APPELLATE_DIR:-$MCP/data/eeoc-appellate}"
export TTAB_DECISIONS_DIR="${TTAB_DECISIONS_DIR:-$MCP/data/ttab-decisions}"
export IBLA_DECISIONS_DIR="${IBLA_DECISIONS_DIR:-$MCP/data/ibla-decisions}"
export CCB_DETERMINATIONS_DIR="${CCB_DETERMINATIONS_DIR:-$MCP/data/ccb-determinations}"
...
for prefix in \
  ...
  AAIB_REPORTS CSB_REPORTS HHS_OIG_REPORTS FSIS_HUMANE EPA_CAFO FMSHRC_ORDERS BSEE_REPORTS OSHRC_ORDERS EPA_ALJ EPA_EAB STB_DECISIONS OALJ_DECISIONS FMC_ORDERS FTC_ORDERS NLRB_DECISIONS FLRA_DECISIONS ECAB_DECISIONS FCC_EB_ORDERS NMB_DETERMINATIONS EEOC_APPELLATE TTAB_DECISIONS IBLA_DECISIONS CCB_DETERMINATIONS
do
  set_grow "$prefix"
done
