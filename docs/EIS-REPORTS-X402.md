...
Applied on apollo (2026-09-08): **serving SHA `9b8953b`** (apply-record [PR 217](https://github.com/bnmbnmai/mcp-proxy/pull/217); merge of [PR 215](https://github.com/bnmbnmai/mcp-proxy/pull/215) collect helpers onto `cursor/apply-oshrc-orders-6483` @ `93d2f1f`). Restarted **only** `idaho-ticks-x402.service` at **2026-09-08 22:49:40 MDT** (PID 609988). One-door collect EXIT 0: listedCount **143**, `addedThisRun` 9 + reused 9, `fetchedPdfs` 10, `captcha.kind=altcha-pow` (127 ms). Public unpaid manifest **200** / **cardCount 1 → 19** / asOf **2026-09-08** / fetchedAt **2026-09-09T04:49:29.236Z**. Navajo Mine `20260116` and Clinch River `20260036` are in the free index (title/date/agency only). Unpaid `GET https://ticks.bnm.farm/eis-reports` is **402** at $0.05; `?id=20260116` is **402** at $0.02. `/.well-known/x402` still lists `/eis-reports` among **55** doors. Banner `mcp /mcp — 55 tools`. Siblings `/ticks` `/oshrc-orders` still 402. No new collect cron. No lander PR from this apply.
