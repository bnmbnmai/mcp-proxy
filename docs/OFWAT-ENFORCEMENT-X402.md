...
Public catalog (`SHOP-INDEX.md` / README) lists this door. MCP tools stay generated from live well-known (do not hardcode a door count). This listing PR does **not** apply on apollo. Unpaid `GET /ofwat-enforcement` is HTTP 402 once the worker apply lands.
