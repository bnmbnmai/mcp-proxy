...
| `GET https://ticks.bnm.farm/fdic-orders` | $0.05 | FDIC institution consent-order / C&D PDF text (this PR; not live — do not deploy / do not restart apollo) |
...
| `GET https://ticks.bnm.farm/cftc-orders` | $0.05 | CFTC institution enforcement-order / settlement PDF text (this PR; not live — do not deploy / do not restart apollo) |
