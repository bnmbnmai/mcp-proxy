...
Applied on apollo (2026-09-07): **serving SHA `3eb5cec`** (FF of [PR 208](https://github.com/bnmbnmai/mcp-proxy/pull/208) onto `cursor/apply-vet402-receipt-e6e8` @ `43f5ce7`). Restarted **only** `idaho-ticks-x402.service` at **2026-09-07 22:54:39 MDT** (PID 1356455). One-door collect EXIT 0 in 32s: `fetchedAt` **2026-09-07T14:13:36.511Z → 2026-09-08T04:56:02.857Z**, `cardCount` still **137**, `listedCount` 386. Did not log `collect failed`. Public unpaid `GET /cfpb-orders` stays **402**.
