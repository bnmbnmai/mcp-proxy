...
Applied on apollo (2026-09-18): **serving SHA `58855b0`** ([PR 252](https://github.com/bnmbnmai/mcp-proxy/pull/252) `cursor/ftc-orders-commission-meta-ac29` onto live tip `cursor/ftc-402-firm-check-26ec` / `f20bdac`). Restarted **only** `idaho-ticks-x402.service` at **2026-09-18 15:36:04 MDT** (PID 19466). Refreshed the existing first-slice bag only (`FTC_ORDERS_LIMIT=5`, `fetchedPdfs` 0, `addedThisRun` 0, `cardCount` still **5**). Commission rows now match ALJ-shaped ids: FleetCor `9403-2026-09-17` (docket `9403`, date `2026-09-17`); Beretta `berettaruger-2026-09-16` (date `2026-09-16`). Remaining official gaps: Beretta docket empty (`Docket No. C` unfinished in the PDF); both Commission D&O filenames have no OSCAR prefix. Unpaid `GET /ftc-orders` still **402**. firm-check finds Beretta / FleetCor / Scott without bodies.
