...
git checkout cursor/apply-bsee-reports-5a99
...
Applied on apollo (2026-09-07): **serving SHA `687416a`** (door merge of PR 202 onto `cursor/apply-settle-metrics-65c4` @ `5d78959`). `idaho-ticks-x402.service` loaded that tree at **2026-09-07 17:05:37 MDT** (PID 1052337) and was not restarted after the later apply-record commits. Branch tip **`3562cb8`** is paperwork only. Collect wrote **18** official 2026 district-investigation texts (`addedThisRun` 18, `fetchedPdfs` 18, skipped 0), listedCount **133**, asOf **2026-07-01**, fetchedAt **2026-09-07T23:05:30.998Z**. Seed `mp-298-cantium-2026-05-24` is in the free manifest (title/date/lease only; PBA 1210/11 stays in the paid body). Unpaid `GET https://ticks.bnm.farm/bsee-reports` is **402** at $0.05; `?id=mp-298-cantium-2026-05-24` is **402** at $0.02. `/.well-known/x402` lists `/bsee-reports` among **49** doors. Banner `mcp /mcp — 49 tools`. Superfund FYR was not applied. No new collect cron. 5pm Boise pulse: still 402 / manifest 200 cardCount 18 asOf 2026-07-01 / 49 doors.
