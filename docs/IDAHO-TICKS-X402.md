...
Paid JSON includes Twin Falls, Blackfoot, AMS_3056 hay, AMS_3059 NW Direct, IF_FV130 onions/potatoes, IBC Idaho elevator grain, and WD1 rental-pool $/AF **when those series are in the cache**. A source that 403s on this host is listed under `failed` (honest), not filled in. Organic hay stays empty unless an official organic quote is present.
